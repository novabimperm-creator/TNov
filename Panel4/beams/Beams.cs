...
namespace TNov
{
    ...
    public class Beams : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            Guid adskMarkIzdParamGuid = new Guid("92ae0425-031b-40a9-8904-023f7389963b"); //A_Марка изделия
            Guid adskMainPartIzdParamGuid = new Guid("7b011a82-6ead-45ee-a188-7a7721dfb452"); //A_Главная деталь изделия
