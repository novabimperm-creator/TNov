...
namespace TNovCommon
{
    public class json
    {
        public json(in string TNovclassname, in bool forProject, out bool exist, out string jsonpath)
        {
            ...
            jsonpath = "//fs-nova/Distr/0.For Admin/_TNov/users/" + userName + "," + date + "," + TNovclassname + ".json";
            if (forProject) { jsonpath = nova.novaserver + "_TNov/projects/" + docName + "," + TNovclassname + ".json"; }
